...
namespace VIS.Models
{
    public class MFrameworkModel
    {
        ...
        public int UpdateGroupByChecked(Ctx ctx, string fields)
        {
            ...
            string sql = @"UPDATE RC_ViewColumn SET IsGroupBy = 'N' WHERE RC_View_ID = " +
                Util.GetValueOfInt(paramValue[0]) + " AND RC_ViewColumn_ID NOT IN (" + Util.GetValueOfInt(paramValue[1]) + ")";
