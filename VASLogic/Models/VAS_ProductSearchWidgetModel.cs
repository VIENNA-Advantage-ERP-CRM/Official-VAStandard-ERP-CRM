 ...
 * Purpose        : Overall Inventory product search widget data
...
namespace VASLogic.Models
{
    ...
    /// Purpose     : Searches active products and returns the complete product
    ///               detail used by the Overall Inventory dashboard modal.
    ///               Every query is parameterized and MRole is applied only to
    ///               its main physical table before CTE bodies are combined.
    /// Chronological development:
    ///   VAI154      2026-06-21 Created
    /// </summary>
    public class VAS_ProductSearchWidgetModel
    {
        /// <summary>
        /// Searches active products by name, value, SKU, UPC, product type, or category.
        /// </summary>
        /// <param name="ctx">Session context used for tenant, organization, and role security.</param>
        /// <param name="searchText">User-entered search text.</param>
        /// <param name="maxRows">Maximum number of suggestions to return.</param>
        /// <returns>Matching product suggestions with current quantity and stock value.</returns>
        public ProductSearchResult SearchProducts(Ctx ctx, string searchText, int maxRows)
        {
        ...
        /// <summary>
        /// Loads the selected product and all data required by the six detail tabs.
        /// </summary>
        /// <param name="ctx">Session context used for tenant, organization, and role security.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Complete product detail, or null when the product is unavailable.</returns>
        public ProductDetail GetProductDetail(Ctx ctx, int productId)
        {
        ...
        /// <summary>
        /// Loads product master attributes for the modal overview and hero.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Product master data, or null when not accessible.</returns>
        ...
        /// <summary>
        /// Loads on-hand quantity and carrying value by warehouse and locator.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Stock rows visible to the current role.</returns>
        private List<ProductStockRow> GetStockRows(Ctx ctx, int productId, VAS_InventorySchemaCurrency currency)
        {
            string costValuesSql = @"
                SELECT Cost.AD_Org_ID AS Cost_Org_ID,
                       Cost.M_Product_ID,
        ...
        /// <summary>
        /// Returns the highest configured reorder point across accessible warehouses.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Reorder point, or zero when no supported replenish rule exists.</returns>
        ...
        /// <summary>
        /// Returns the first active preferred supplier alphabetically.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Supplier name, or an empty string.</returns>
        ...
        /// <summary>
        /// Loads the latest five purchase or sales order lines for the product.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <param name="isSales">True for sales orders; false for purchase orders.</param>
        /// <returns>Latest order line rows.</returns>
        ...
        /// <summary>
        /// Loads the latest five stock movements for the product.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Latest movement rows.</returns>
        ...
        /// <summary>
        /// Loads the latest five requisition lines for the product.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="productId">Selected M_Product_ID.</param>
        /// <returns>Latest requisition rows.</returns>
        ...
        /// <summary>
        /// Applies row-level security to the main physical table in a query body.
        /// </summary>
        /// <param name="ctx">Session context.</param>
        /// <param name="sql">Physical-table SELECT before trailing GROUP BY or ORDER BY.</param>
        /// <param name="tableAlias">Alias of the main physical table.</param>
        /// <returns>SQL with MRole access predicates.</returns>
        ...
        /// <summary>
        /// Formats a nullable date as an invariant ISO date string.
        /// </summary>
        /// <param name="value">Nullable date value.</param>
        /// <returns>ISO date, or an empty string.</returns>
        ...
        /// <summary>
        /// Formats a nullable timestamp for transport to the client.
        /// </summary>
        /// <param name="value">Nullable timestamp value.</param>
        /// <returns>Invariant date and time, or an empty string.</returns>
        ...
        /// <summary>
        /// Closes and disposes a data reader when one was opened.
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Product suggestion response envelope.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : One product suggestion row.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Full modal payload for a selected product.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Product master attributes shown in the modal.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Product quantity and value for one locator.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Purchase or sales order line shown in a detail tab.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Stock movement shown in the Movements tab.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        ...
        /// <summary>
        /// Module Name : VAS_ProductSearchWidget
        /// Purpose     : Requisition line shown in the Requisitions tab.
        /// Chronological development:
        ///   VAI154      2026-06-21 Created
        /// </summary>
        public class ProductRequisitionRow
        {
            public string DocumentNo { get; set; }
