...
namespace VASLogic.Models
{
    ...
    /// Purpose     : Loads locator stock and relative ageing in schema currency.
    /// Chronological development:
    ///   VAI154      2026-06-21 Created
    ///   VAI154      2026-06-22 Updated for schema currency
    /// </summary>
    public class VAS_WarehouseStockWidgetModel
    {
        /// <summary>
        ...
        public List<VAS_WarehouseStockWarehouse> GetWarehouses(Ctx ctx)
        {
            List<VAS_WarehouseStockWarehouse> warehouses = new List<VAS_WarehouseStockWarehouse>();
            ...
            try
            {
                ...
                {
                    warehouses.Add(new VAS_WarehouseStockWarehouse
                    {
        ...
        /// <summary>
        /// Loads active locator stock and ageing values.
        /// </summary>
        /// <param name="ctx">Current session context.</param>
        /// <returns>Stock rows and schema currency configuration.</returns>
        public VAS_WarehouseStockResult GetStockRows(Ctx ctx)
        {
            VAS_WarehouseStockResult result = new VAS_WarehouseStockResult
            {
                rows = new List<VAS_WarehouseStockRow>()
            };
            ...
            try
            {
                ...
                while (reader != null && reader.Read())
                {
                    result.rows.Add(new VAS_WarehouseStockRow
                    {
                        warehouse_id = Util.GetValueOfInt(reader["Warehouse_ID"]),
                        warehouse_code = Util.GetValueOfString(reader["Warehouse_Code"]),
                        warehouse_name = Util.GetValueOfString(reader["Warehouse_Name"]),
    ...
    public class VAS_WarehouseStockWarehouse
    {
    ...
    /// <summary>Locator rows and schema currency configuration.</summary>
    public class VAS_WarehouseStockResult
    {
        public List<VAS_WarehouseStockRow> rows { get; set; }
        public string currency_symbol { get; set; }
        public string currency_iso { get; set; }
        public int std_precision { get; set; }
    }

    /// <summary>One locator stock and ageing row.</summary>
    public class VAS_WarehouseStockRow
    {
        public int warehouse_id { get; set; }
        public string warehouse_code { get; set; }
        public string warehouse_name { get; set; }
