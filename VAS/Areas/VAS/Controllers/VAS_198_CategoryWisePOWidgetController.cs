...
{
    public class VAS_198_CategoryWisePOWidgetController : Controller
    {
        private static readonly VLogger _log = VLogger.GetVLogger(typeof(VAS_198_CategoryWisePOWidgetController).FullName);
