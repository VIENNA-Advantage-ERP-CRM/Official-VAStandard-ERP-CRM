 ...
 * Purpose        : Material Transfer Bottom Panel — controller
...
{
    /// <summary>
    /// AJAX endpoints for the VAS_247_MaterialTransferBottomPanel tab panel — the
    /// material-transfer counterpart of VAS_240_RequisitionBottomPanel. Each action
    /// reads the session Ctx, delegates to
    /// <see cref="VAS_247_MaterialTransferBottomPanelModel"/> and returns the
    /// serialized result. Reads use GET; write actions use HttpPost + payload.
    /// There is no pricing endpoint: a movement line carries no price or tax.
    /// </summary>
    public class VAS_247_MaterialTransferBottomPanelController : Controller
    {
        /// <summary>Returns the parent movement context and one page of its saved lines.</summary>
        ...
        public JsonResult GetPanelData(int M_Movement_ID, int AD_Window_ID, int page = 0)
        {
            string retJSON = "";
            if (Session["ctx"] != null)
            {
                Ctx ctx = Session["ctx"] as Ctx;
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(model.GetPanelData(ctx, M_Movement_ID, AD_Window_ID, page));
            }
            return Json(retJSON, JsonRequestBehavior.AllowGet);
        }

        /// <summary>Paged product catalog search (50 rows + scroll paging).</summary>
        ...
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult SearchCatalog(int M_Movement_ID, string query, int pageSize, int offset, string rowContext)
        {
            string retJSON = "";
            if (Session["ctx"] != null)
            {
                Ctx ctx = Session["ctx"] as Ctx;
                // Current line context (compact JSON) so a per-row product AD_Val_Rule
                // re-filters the catalog; absent / malformed -> header context only.
                ...
                retJSON = JsonConvert.SerializeObject(
                    model.SearchProductsCharges(ctx, M_Movement_ID, query, pageSize, offset, rowValues));
            }
            return Json(retJSON, JsonRequestBehavior.AllowGet);
        }
        ...
        /// + movement header + session context).
        /// </summary>
        /// <param name="payload">serialized MovementLookupRequest</param>
        ...
        public JsonResult GetLookupData(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                MovementLookupRequest req = JsonConvert.DeserializeObject<MovementLookupRequest>(payload);
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
        ...
        /// </summary>
        /// <param name="payload">serialized MovementRefLookupRequest</param>
        ...
        public JsonResult GetRefLookup(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                MovementRefLookupRequest req = JsonConvert.DeserializeObject<MovementRefLookupRequest>(payload);
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
        ...
        /// <summary>
        /// Reads the changed column's AD_Column.Callout and returns the values the
        /// framework derives — the line's unit and the base-unit MovementQty — as a patch
        /// the client applies back onto the line. No row is written.
        /// </summary>
        /// <param name="M_Movement_ID">parent movement</param>
        ...
        /// <param name="M_Locator_ID">source locator</param>
        /// <param name="M_LocatorTo_ID">destination locator</param>
        /// <returns>serialized MovementCalloutResult (Column + Callout + Values + Display)</returns>
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult RunCallout(int M_Movement_ID, string TriggerColumn, int M_Product_ID,
            int M_AttributeSetInstance_ID, decimal QtyEntered, int C_UOM_ID,
            int M_Locator_ID, int M_LocatorTo_ID)
        {
            string retJSON = "";
            if (Session["ctx"] != null)
            {
                Ctx ctx = Session["ctx"] as Ctx;
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(model.RunColumnCallout(ctx, new MovementLineCalcRequest
                {
        ...
        /// <summary>Looks up a product by a scanned barcode.</summary>
        ...
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult ScanLookup(int M_Movement_ID, string code)
        {
            string retJSON = "";
            if (Session["ctx"] != null)
            {
                Ctx ctx = Session["ctx"] as Ctx;
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(model.ScanLookup(ctx, M_Movement_ID, code));
            }
            return Json(retJSON, JsonRequestBehavior.AllowGet);
        }
        ...
        /// Delegates entirely to the model so all framework dedup, mandatory-validation
        /// and AttrCode / UPC behaviour stays in the model layer.
        /// </summary>
        /// <param name="payload">serialized MovementAttributeSaveRequest</param>
        /// <returns>serialized MovementAttributeSaveResult (id 0 + Error on failure)</returns>
        [HttpPost]
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult SaveAttribute(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                MovementAttributeSaveRequest req = JsonConvert.DeserializeObject<MovementAttributeSaveRequest>(payload);
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
        ...
        /// <summary>Inserts / updates the supplied movement lines through MMovementLine.</summary>
        /// <param name="payload">serialized MovementSaveLinesRequest</param>
        ...
        public JsonResult SaveLines(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                MovementSaveLinesRequest req = JsonConvert.DeserializeObject<MovementSaveLinesRequest>(payload);
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(
                    model.SaveLines(ctx, req.M_Movement_ID, req.AD_Window_ID, req.Lines, req.Page));
            }
            return Json(retJSON, JsonRequestBehavior.AllowGet);
        }

        /// <summary>Deletes the supplied saved movement lines through MMovementLine.</summary>
        /// <param name="payload">serialized MovementDeleteLinesRequest</param>
        /// <returns>serialized save result (refreshed page or error key)</returns>
        [HttpPost]
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult DeleteLines(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                MovementDeleteLinesRequest req = JsonConvert.DeserializeObject<MovementDeleteLinesRequest>(payload);
                VAS_247_MaterialTransferBottomPanelModel model = new VAS_247_MaterialTransferBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(
                    model.DeleteLines(ctx, req.M_Movement_ID, req.AD_Window_ID, req.LineIds, req.Page));
            }
            return Json(retJSON, JsonRequestBehavior.AllowGet);
        }
    }
