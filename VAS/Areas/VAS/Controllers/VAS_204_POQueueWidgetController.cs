/************************************************************
 * Module Name    : VAS
 * Purpose        : Controller for PO Queue Widget (Widget 14: VAS_204_POQueueWidget)
...
{
    /// <summary>
    /// Controller for Widget 14: PO Queue (VAS_204_POQueueWidget)
    /// </summary>
    public class VAS_204_POQueueWidgetController : Controller
    {
        private static readonly VLogger _log = VLogger.GetVLogger(typeof(VAS_204_POQueueWidgetController).FullName);
