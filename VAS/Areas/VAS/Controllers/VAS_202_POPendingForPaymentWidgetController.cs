...
{
    /// <summary>
    /// Controller for Widget 12: PO Pending for Payment (VAS_202_POPendingForPaymentWidget)
    /// </summary>
    public class VAS_202_POPendingForPaymentWidgetController : Controller
    {
        private static readonly VLogger Log = VLogger.GetVLogger(typeof(VAS_202_POPendingForPaymentWidgetController).FullName);
        ...
        public JsonResult GetPOPendingForPayment()
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_202_POPendingForPaymentWidget.GetPOPendingForPayment", ex);
        ...
        public JsonResult GetPOLines(int C_Order_ID)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_202_POPendingForPaymentWidget.GetPOLines", ex);
                return Json(JsonConvert.SerializeObject(new { error = Msg.GetMsg(ctx, "Error") ?? "Error", success = false }), JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetPODetail(int C_Order_ID)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_202_POPendingForPaymentWidget.GetPODetail", ex);
                return Json(JsonConvert.SerializeObject(new { error = Msg.GetMsg(ctx, "Error") ?? "Error", success = false }), JsonRequestBehavior.AllowGet);
            }
        }
    }
