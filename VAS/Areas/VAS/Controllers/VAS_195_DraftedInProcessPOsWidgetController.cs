 ...
 * Widget ID      : VAS_195_DraftedInProcessPOsWidget
 ***********************************************************/
...
namespace VIS.Controllers
{
    ...
    /// </summary>
    public class VAS_195_DraftedInProcessPOsWidgetController : Controller
    {
        private static readonly VLogger _log = VLogger.GetVLogger(typeof(VAS_195_DraftedInProcessPOsWidgetController).FullName);
        ...
        public JsonResult GetDraftedInProcessPOsData()
        {
                ...
                try
                {
                    ...
                    while (dr != null && dr.Read())
                    {
                        ...
                        if (baseCurrency.CurrencyId > 0 && currencyId > 0 && currencyId != baseCurrency.CurrencyId)
                        {
                            ...
                            {
                                _log.Warning("VAS_195: Rate conversion failed for C_Order_ID " + orderId + ": " + exConv.Message);
            ...
            {
                _log.Severe("VAS_195_DraftedInProcessPOsWidget.GetDraftedInProcessPOsData: " + ex.ToString());
        ...
        public JsonResult GetOrderLines(int C_Order_ID)
        {
            ...
            {
                _log.Severe("VAS_195_DraftedInProcessPOsWidget.GetOrderLines: " + ex.ToString());
                return Json(new { error = ex.Message }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        private CurrencyInfo GetAccountingCurrency(Ctx ctx, int clientId)
        {
            ...
            {
                _log.Warning("VAS_195: Error fetching accounting currency: " + ex.Message);
            }
            finally
            {
                if (dr != null)
