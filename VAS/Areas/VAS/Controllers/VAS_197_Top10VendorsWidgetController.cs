...
{
    public class VAS_197_Top10VendorsWidgetController : Controller
    {
        private static readonly VLogger Log = VLogger.GetVLogger(typeof(VAS_197_Top10VendorsWidgetController).FullName);
        ...
        public JsonResult GetTopVendors(int month, int year)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_197_Top10VendorsWidget.GetTopVendors", ex);
        ...
        public JsonResult GetVendorPurchaseOrders(int vendorId, int month, int year)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_197_Top10VendorsWidget.GetVendorPurchaseOrders", ex);
                return Json(JsonConvert.SerializeObject(new { error = Msg.GetMsg(ctx, "Error") ?? "Error", message = ex.Message }), JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetPurchaseOrderLines(int orderId)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_197_Top10VendorsWidget.GetPurchaseOrderLines", ex);
                return Json(JsonConvert.SerializeObject(new { error = Msg.GetMsg(ctx, "Error") ?? "Error", message = ex.Message }), JsonRequestBehavior.AllowGet);
            }
        }
