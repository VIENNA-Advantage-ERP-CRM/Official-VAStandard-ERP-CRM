...
namespace VAS.Controllers
{
    public class InventoryLinesController : Controller
    {
        ...
        public JsonResult GetIventoryCartData(string CartName, string UserId,string FromDate,string ToDate, string RefNo,int windowID, int RecordId,string WindowName)
        {
