...
{
    public class VAS_203_RepresentativeWisePOWidgetController : Controller
    {
        private static readonly VLogger Log = VLogger.GetVLogger(typeof(VAS_203_RepresentativeWisePOWidgetController).FullName);
        ...
        public JsonResult GetRepresentativeWisePO(int month, int year)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_203_RepresentativeWisePOWidget.GetRepresentativeWisePO", ex);
        ...
        public JsonResult GetRepresentativePurchaseOrders(int representativeId, int month, int year)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_203_RepresentativeWisePOWidget.GetRepresentativePurchaseOrders", ex);
                return Json(JsonConvert.SerializeObject(new { error = Msg.GetMsg(ctx, "Error") ?? "Error", message = ex.Message }), JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetPurchaseOrderLines(int orderId)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_203_RepresentativeWisePOWidget.GetPurchaseOrderLines", ex);
                return Json(JsonConvert.SerializeObject(new { error = Msg.GetMsg(ctx, "Error") ?? "Error", message = ex.Message }), JsonRequestBehavior.AllowGet);
            }
        }
