...
{
    /// <summary>
    /// Controller for VAS_200_ExpectedLandedCostWidget (Expected Landed Cost on PO).
    ...
    /// </summary>
    public class VAS_200_ExpectedLandedCostWidgetController : Controller
    {
        private static readonly VLogger _log = VLogger.GetVLogger(typeof(VAS_200_ExpectedLandedCostWidgetController).FullName);
        ...
        public JsonResult GetExpectedLandedCost(int month, int year)
        {
            ...
            {
                _log.Log(Level.SEVERE, "VAS_200_ExpectedLandedCostWidget.GetExpectedLandedCost", ex);
