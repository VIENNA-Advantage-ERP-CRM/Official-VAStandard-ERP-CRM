...
namespace VIS.Controllers
{
    ...
    /// Widget ID   : VAS_192_NewPurchaseOrderWidget
    ...
    /// </summary>
    public class VAS_192_NewPurchaseOrderWidgetController : Controller
    {
        private static readonly VLogger Log = VLogger.GetVLogger(typeof(VAS_192_NewPurchaseOrderWidgetController).FullName);
        ...
        public JsonResult GetPurchaseOrderWindowId()
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_192_NewPurchaseOrderWidget.GetPurchaseOrderWindowId", ex);
        ...
        public JsonResult GetOpenRequisitions()
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_192_NewPurchaseOrderWidget.GetOpenRequisitions", ex);
                return Fail(ex.Message);
            }
            finally
            {
        ...
        public JsonResult GetRequisitionLines(int requisitionId = 0)
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_192_NewPurchaseOrderWidget.GetRequisitionLines", ex);
                return Fail(ex.Message);
            }
            finally
            {
        ...
        public JsonResult GetFormLookups()
        {
            ...
            {
                Log.Log(Level.SEVERE, "VAS_192_NewPurchaseOrderWidget.GetFormLookups", ex);
                return Fail(ex.Message);
            }
        }
            ...
            string linesJson = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Log(Level.SEVERE, "VAS_192_NewPurchaseOrderWidget.CreatePurchaseOrder", ex);
                return Fail(ex.Message);
            }
            finally
            {
