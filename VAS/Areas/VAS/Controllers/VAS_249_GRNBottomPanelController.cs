 ...
 * Purpose        : GRN Bottom Panel — controller
...
{
    /// <summary>
    /// AJAX endpoints for the VAS_249_GRNBottomPanel tab panel — the
    /// vendor-receipt counterpart of VAS_240_RequisitionBottomPanel. Each action
    /// reads the session Ctx, delegates to
    /// <see cref="VAS_249_GRNBottomPanelModel"/> and returns the serialized
    /// result. Reads use GET; write actions use HttpPost + payload. There is no
    /// pricing endpoint: a receipt line carries no price or tax.
    ///
    /// Every action is direction-guarded inside the model: a customer shipment id posted
    /// to this route is refused, so these endpoints cannot be used to edit a delivery.
    /// </summary>
    public class VAS_249_GRNBottomPanelController : Controller
    {
        /// <summary>Returns the parent receipt context and one page of its saved lines.</summary>
        ...
        /// receipt header + session context).
        /// </summary>
        /// <param name="payload">serialized ReceiptLookupRequest</param>
        ...
        public JsonResult GetLookupData(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                ReceiptLookupRequest req = JsonConvert.DeserializeObject<ReceiptLookupRequest>(payload);
                VAS_249_GRNBottomPanelModel model = new VAS_249_GRNBottomPanelModel();
        ...
        /// </summary>
        /// <param name="payload">serialized ReceiptRefLookupRequest</param>
        ...
        public JsonResult GetRefLookup(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                ReceiptRefLookupRequest req = JsonConvert.DeserializeObject<ReceiptRefLookupRequest>(payload);
                VAS_249_GRNBottomPanelModel model = new VAS_249_GRNBottomPanelModel();
        ...
        /// <param name="M_Locator_ID">the bin the goods arrive in</param>
        /// <returns>serialized ReceiptCalloutResult (Column + Callout + Values + Display)</returns>
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
            ...
            int M_Locator_ID)
        {
            ...
            if (Session["ctx"] != null)
            {
                Ctx ctx = Session["ctx"] as Ctx;
                VAS_249_GRNBottomPanelModel model = new VAS_249_GRNBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(model.RunColumnCallout(ctx, new ReceiptLineCalcRequest
                {
        ...
        /// </summary>
        /// <param name="payload">serialized ReceiptAttributeSaveRequest</param>
        /// <returns>serialized ReceiptAttributeSaveResult (id 0 + Error on failure)</returns>
        [HttpPost]
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult SaveAttribute(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                ReceiptAttributeSaveRequest req = JsonConvert.DeserializeObject<ReceiptAttributeSaveRequest>(payload);
                VAS_249_GRNBottomPanelModel model = new VAS_249_GRNBottomPanelModel();
        ...
        /// <summary>Inserts / updates the supplied receipt lines through MInOutLine.</summary>
        /// <param name="payload">serialized ReceiptSaveLinesRequest</param>
        ...
        public JsonResult SaveLines(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                ReceiptSaveLinesRequest req = JsonConvert.DeserializeObject<ReceiptSaveLinesRequest>(payload);
                VAS_249_GRNBottomPanelModel model = new VAS_249_GRNBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(
        ...
        /// <param name="payload">serialized ReceiptDeleteLinesRequest</param>
        /// <returns>serialized save result (refreshed page or error key)</returns>
        [HttpPost]
        [AjaxAuthorizeAttribute]
        [AjaxSessionFilterAttribute]
        public JsonResult DeleteLines(string payload)
        {
            ...
            {
                Ctx ctx = Session["ctx"] as Ctx;
                ReceiptDeleteLinesRequest req = JsonConvert.DeserializeObject<ReceiptDeleteLinesRequest>(payload);
                VAS_249_GRNBottomPanelModel model = new VAS_249_GRNBottomPanelModel();
                retJSON = JsonConvert.SerializeObject(
