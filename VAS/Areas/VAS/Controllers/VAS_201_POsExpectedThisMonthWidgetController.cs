...
{
    /// <summary>
    /// Controller for Widget 11: POs Expected This Month (VAS_201_POsExpectedThisMonthWidget)
    /// </summary>
    public class VAS_201_POsExpectedThisMonthWidgetController : Controller
    {
        private static readonly VLogger _log = VLogger.GetVLogger(typeof(VAS_201_POsExpectedThisMonthWidgetController).FullName);
        ...
        public JsonResult GetPOsExpectedThisMonth(int? year = null, int? month = null)
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    foreach (DataRow row in ds.Tables[0].Rows)
                    {
                        ...
                        if (orderCurId != schemaCurrencyId && schemaCurrencyId > 0 && poValue != 0m)
                        {
                            ...
                            {
                                _log.Log(Level.WARNING, "VAS_201: Currency conversion failed for PO " + poNo, exConv);
                            }
                        }
                ...
                totalOpenSql = MRole.GetDefault(ctx).AddAccessSQL(totalOpenSql, "o", MRole.SQL_FULLYQUALIFIED, MRole.SQL_RO);
            ...
            {
                _log.Log(Level.SEVERE, "VAS_201_POsExpectedThisMonthWidget.GetPOsExpectedThisMonth", ex);
        ...
        public JsonResult GetPOLines(int C_Order_ID)
        {
            ...
            {
                _log.Log(Level.SEVERE, "VAS_201_POsExpectedThisMonthWidget.GetPOLines", ex);
        ...
        public JsonResult GetPODetail(int C_Order_ID)
        {
            ...
            {
                _log.Log(Level.SEVERE, "VAS_201_POsExpectedThisMonthWidget.GetPODetail", ex);
