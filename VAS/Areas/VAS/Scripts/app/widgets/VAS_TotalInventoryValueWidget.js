...
; (function (VAS, $) {
    ...
    VAS.VAS_TotalInventoryValueWidget = function () {
        ...
        function loadValue() {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_TotalInventoryValueWidget/GetTotalInventoryValue',
                type: 'GET',
                cache: false,
    ...
    VAS.VAS_TotalInventoryValueWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_TotalInventoryValueWidget.prototype.widgetSizeChange = function () { };

    VAS.VAS_TotalInventoryValueWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_TotalInventoryValueWidget.prototype.dispose = function () {
