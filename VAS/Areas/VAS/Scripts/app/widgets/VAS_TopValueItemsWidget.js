...
; (function (VAS, $) {
    ...
    VAS.VAS_TopValueItemsWidget = function () {
        ...
        function loadItems() {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_TopValueItemsWidget/GetTopValueItems',
                type: 'GET',
                data: requestData,
                cache: false,
        ...
        function loadWarehouses() {
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_TopValueItemsWidget/GetWarehouses',
                type: 'GET',
                cache: false,
                success: function (response) {
    ...
    VAS.VAS_TopValueItemsWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_TopValueItemsWidget.prototype.widgetSizeChange = function () { };

    VAS.VAS_TopValueItemsWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_TopValueItemsWidget.prototype.dispose = function () {
