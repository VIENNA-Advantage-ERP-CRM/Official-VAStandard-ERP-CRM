 ...
 * ---+---------------------------------------+------------------------------------
 *  1 | Category wise PO                      | VAS_210_CategoryWisePO
 *  2 | Total PO value                        | VAS_210_TotalPOValue
 *  3 | Category value                        | VAS_210_CategoryValue
 *  4 | Share                                 | VAS_210_Share
 *  5 | POs                                   | VAS_210_POs
 *  6 | Vendors                               | VAS_210_Vendors
 *  7 | Purchase orders in this category      | VAS_210_PurchaseOrdersInCategory
 *  8 | Purchase order lines                  | VAS_210_PurchaseOrderLines
 *  9 | Showing                               | VAS_210_Showing
 * 10 | of                                    | VAS_210_Of
 * 11 | Page                                  | VAS_210_Page
 * 12 | Close                                 | VAS_210_Close
 * 13 | Back                                  | VAS_210_Back
 * 14 | PO No                                 | VAS_210_PONo
 * 15 | PO date                               | VAS_210_PODate
 * 16 | Vendor                                | VAS_210_Vendor
 * 17 | Warehouse                             | VAS_210_Warehouse
 * 18 | Representative                        | VAS_210_Representative
 * 19 | Value                                 | VAS_210_Value
 * 20 | Delivery                              | VAS_210_Delivery
 * 21 | Status                                | VAS_210_Status
 * 22 | Product                               | VAS_210_Product
 * 23 | Attribute                             | VAS_210_Attribute
 * 24 | UoM                                   | VAS_210_UoM
 * 25 | Ordered                               | VAS_210_Ordered
 * 26 | Received                              | VAS_210_Received
 * 27 | Pending                               | VAS_210_Pending
 * 28 | Rate                                  | VAS_210_Rate
 * 29 | Amount                                | VAS_210_Amount
 * 30 | Line status                           | VAS_210_LineStatus
 * 31 | Lines                                 | VAS_210_Lines
 * 32 | Qty ordered                           | VAS_210_QtyOrdered
 * 33 | Qty pending                           | VAS_210_QtyPending
 * 34 | No purchase orders for this period.   | VAS_210_NoData
 * 35 | select a PO number to open record     | VAS_210_SelectPOToOpen
 * 36 | Other                                 | VAS_210_Other
 * 37 | Uncategorised                         | VAS_210_Uncategorised
 * 38 | Loading...                            | VAS_210_Loading
 * 39 | Purchase order                        | VAS_210_PurchaseOrder
 * 40 | Category purchase orders              | VAS_210_CategoryPurchaseOrders
 * 41 | % of PO value                         | VAS_210_OfPOValue
 * 42 | Error loading lines.                  | VAS_210_ErrorLoadingLines
...
; (function (VAS, $) {
    ...
    VAS.VAS_210_CategoryWisePOWidget = function () {
        ...
        function loadCategoryData() {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_210_CategoryWisePOWidget/GetCategoryWisePO',
                type: 'GET',
        ...
        function renderDonut() {
            ...
            var totalCaption = lbl("VAS_210_TotalPOValue", "Total PO value");
        ...
        function openModalShell(cfg, isBack) {
            ...
            var backBtnHtml = hasBack
                ? '<button type="button" class="vas-cpow-xbtn vas-cpow-m-back" aria-label="' + escapeHtml(lbl("VAS_210_Back", "Back")) + '">' +
            ...
            var modalHtml =
                ...
                '        <button type="button" class="vas-cpow-xbtn vas-cpow-m-close" aria-label="' + escapeHtml(lbl("VAS_210_Close", "Close")) + '">' +
                ...
                '      <button type="button" class="vas-cpow-btn vas-cpow-m-close-btn">' + escapeHtml(lbl("VAS_210_Close", "Close")) + '</button>' +
                '    </div>' +
                '  </div>' +
                '</div>';
        ...
        function openCategoryModal(catItem) {
            ...
            var subtitle = lbl("VAS_210_CategoryPurchaseOrders", "Category purchase orders") + ' · ' + periodLabel() + ' · ' + catItem.Share + lbl("VAS_210_OfPOValue", "% of PO value");

            var statStripHtml =
                '<div class="vas-cpow-mstats">' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_CategoryValue", "Category value")) + '</div><div class="v">' + escapeHtml(formatCurrency(catItem.CategoryValue)) + '</div></div>' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_Share", "Share")) + '</div><div class="v">' + catItem.Share + '%</div></div>' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_POs", "POs")) + '</div><div class="v">' + formatNumber(catItem.PoCount) + '</div></div>' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_Vendors", "Vendors")) + '</div><div class="v">' + formatNumber(catItem.VendorCount) + '</div></div>' +
                '</div>';

            var bodyHtml =
                statStripHtml +
                '<div class="vas-cpow-msec">' + escapeHtml(lbl("VAS_210_PurchaseOrdersInCategory", "Purchase orders in this category")) + '</div>' +
                ...
                '      <span class="vas-cpow-cell vas-cpow-col-pono">' + escapeHtml(lbl("VAS_210_PONo", "PO No")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-col-podate">' + escapeHtml(lbl("VAS_210_PODate", "PO date")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-col-vendor">' + escapeHtml(lbl("VAS_210_Vendor", "Vendor")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-col-wh">' + escapeHtml(lbl("VAS_210_Warehouse", "Warehouse")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-col-rep">' + escapeHtml(lbl("VAS_210_Representative", "Representative")) + '</span>' +
                '      <span class="vas-cpow-cell right vas-cpow-col-val">' + escapeHtml(lbl("VAS_210_Value", "Value")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-col-deliv">' + escapeHtml(lbl("VAS_210_Delivery", "Delivery")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-col-status">' + escapeHtml(lbl("VAS_210_Status", "Status")) + '</span>' +
                '    </div>' +
                '    <div class="vas-cpow-mbody vas-cpow-po-mbody">' +
                '      <div class="vas-cpow-mrow"><span class="vas-cpow-cell" style="grid-column:1/-1;text-align:center;padding:1em;">' + escapeHtml(lbl("VAS_210_Loading", "Loading...")) + '</span></div>' +
                '    </div>' +
                '  </div>' +
        ...
        function loadCategoryPODrilldownData($m, catItem, catIds) {
            ...
            function renderPOTable() {
                ...
                if (poList.length === 0) {
                    $mbody.html('<div class="vas-cpow-mrow"><span class="vas-cpow-cell" style="grid-column:1/-1;text-align:center;padding:1.5em;color:#5F7283;">' + escapeHtml(lbl("VAS_210_NoData", "No purchase orders for this period.")) + '</span></div>');
                    $helper.text('0 ' + lbl("VAS_210_Of", "of") + ' 0');
                    $ptxt.text('1 ' + lbl("VAS_210_Of", "of") + ' 1');
                ...
                var showingTxt = lbl("VAS_210_Showing", "Showing") + ' ' + (start + 1) + '–' + (start + slice.length) + ' ' +
                                 lbl("VAS_210_Of", "of") + ' ' + poList.length + ' · ' + catItem.CategoryName;
                $helper.text(showingTxt);
                $ptxt.text((poPage + 1) + ' ' + lbl("VAS_210_Of", "of") + ' ' + totalPages);
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_210_CategoryWisePOWidget/GetCategoryPODrillDown',
                type: 'GET',
        ...
        function openPOLinesModal(orderId) {
            var cfg = {
                isChild: true,
                size: 'md',
                title: lbl("VAS_210_Lines", "Lines") + ' · ...',
                subtitle: '',
                bodyHtml: '<div class="vas-cpow-polines-loader" style="text-align:center;padding:2em;color:#5F7283;">' + escapeHtml(lbl("VAS_210_Loading", "Loading...")) + '</div>',
                afterRender: function ($m) {
        ...
        function loadPOLinesData($m, orderId) {
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_210_CategoryWisePOWidget/GetPOLines',
                type: 'GET',
                ...
                error: function () {
                    $m.find('.vas-cpow-modal-body').html('<div style="text-align:center;padding:2em;color:#A33F3F;">' + escapeHtml(lbl("VAS_210_ErrorLoadingLines", "Error loading lines.")) + '</div>');
                }
            });
        }

        function renderPOLinesModalContent($m, header, lines) {
            $m.find('.vas-cpow-m-title').text(lbl("VAS_210_Lines", "Lines") + ' · ' + (header.DocumentNo || ''));
            $m.find('.vas-cpow-m-sub').text((header.Vendor || '') + ' · ' + (header.DateOrdered || '') + ' · ' + (header.DeliveryStatus || ''));

            var polinkHtml =
                '<div class="vas-cpow-polink">' +
                '  ' + escapeHtml(lbl("VAS_210_PurchaseOrder", "Purchase order")) + ' ' +
            ...
            var statStripHtml =
                '<div class="vas-cpow-mstats">' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_Lines", "Lines")) + '</div><div class="v">' + lines.length + '</div></div>' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_POValue", "PO value")) + '</div><div class="v">' + escapeHtml(formatCurrency(header.TotalValue)) + '</div></div>' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_QtyOrdered", "Qty ordered")) + '</div><div class="v">' + formatNumber(header.TotalQtyOrdered) + '</div></div>' +
                '  <div class="vas-cpow-mstat"><div class="l">' + escapeHtml(lbl("VAS_210_QtyPending", "Qty pending")) + '</div><div class="v">' + formatNumber(header.TotalQtyPending) + '</div></div>' +
                '</div>';

            var bodyHtml =
                polinkHtml +
                statStripHtml +
                '<div class="vas-cpow-msec">' + escapeHtml(lbl("VAS_210_PurchaseOrderLines", "Purchase order lines")) + '</div>' +
                '<div class="vas-cpow-table-container">' +
                '  <div class="vas-cpow-mtbl">' +
                '    <div class="vas-cpow-mrow vas-cpow-lines-mhead">' +
                '      <span class="vas-cpow-cell right vas-cpow-lcol-seq">#</span>' +
                '      <span class="vas-cpow-cell vas-cpow-lcol-prod">' + escapeHtml(lbl("VAS_210_Product", "Product")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-lcol-attr">' + escapeHtml(lbl("VAS_210_Attribute", "Attribute")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-lcol-uom">' + escapeHtml(lbl("VAS_210_UoM", "UoM")) + '</span>' +
                '      <span class="vas-cpow-cell right vas-cpow-lcol-ord">' + escapeHtml(lbl("VAS_210_Ordered", "Ordered")) + '</span>' +
                '      <span class="vas-cpow-cell right vas-cpow-lcol-recd">' + escapeHtml(lbl("VAS_210_Received", "Received")) + '</span>' +
                '      <span class="vas-cpow-cell right vas-cpow-lcol-pend">' + escapeHtml(lbl("VAS_210_Pending", "Pending")) + '</span>' +
                '      <span class="vas-cpow-cell right vas-cpow-lcol-rate">' + escapeHtml(lbl("VAS_210_Rate", "Rate")) + '</span>' +
                '      <span class="vas-cpow-cell right vas-cpow-lcol-amt">' + escapeHtml(lbl("VAS_210_Amount", "Amount")) + '</span>' +
                '      <span class="vas-cpow-cell vas-cpow-lcol-st">' + escapeHtml(lbl("VAS_210_LineStatus", "Line status")) + '</span>' +
                '    </div>' +
            ...
            function renderLinesTable() {
                ...
                if (lines.length === 0) {
                    $linesBody.html('<div class="vas-cpow-mrow"><span class="vas-cpow-cell" style="grid-column:1/-1;text-align:center;padding:1.5em;color:#5F7283;">' + escapeHtml(lbl("VAS_210_NoLinesAvailable", "No lines available.")) + '</span></div>');
                    $linesHelper.text('0 ' + lbl("VAS_210_Of", "of") + ' 0');
                    $linesPtxt.text('1 ' + lbl("VAS_210_Of", "of") + ' 1');
                ...
                var showingTxt = lbl("VAS_210_Showing", "Showing") + ' ' + (start + 1) + '–' + (start + slice.length) + ' ' +
                                 lbl("VAS_210_Of", "of") + ' ' + lines.length + ' · ' + lbl("VAS_210_LinesOf", "lines of") + ' ' + header.DocumentNo;
                $linesHelper.text(showingTxt);
                $linesPtxt.text((linesPage + 1) + ' ' + lbl("VAS_210_Of", "of") + ' ' + totalPages);
    ...
    VAS.VAS_210_CategoryWisePOWidget.prototype.widgetFirevalueChanged = function (value) {
        if (this.listener) { this.listener.widgetFirevalueChanged(value); }
    };

    VAS.VAS_210_CategoryWisePOWidget.prototype.addChangeListener = function (listener) {
        this.listener = listener;
    };

    VAS.VAS_210_CategoryWisePOWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_210_CategoryWisePOWidget.prototype.widgetSizeChange = function (height, width) { };

    VAS.VAS_210_CategoryWisePOWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_210_CategoryWisePOWidget.prototype.dispose = function () {
