...
; (function (VAS, $) {
    ...
    VAS.VAS_208_MonthlyPOTrendWidget = function () {
        ...
        function loadTrendData() {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_208_MonthlyPOTrendWidget/GetTrendData',
                type: 'GET',
                data: {
        ...
        function openMonthPODrilldown(year, month) {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_208_MonthlyPOTrendWidget/GetMonthPODrilldown',
                type: 'GET',
        ...
        function openPOLinesDrilldown(orderId, poNo, curSym) {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_208_MonthlyPOTrendWidget/GetPOLineDetails',
                type: 'GET',
    ...
    VAS.VAS_208_MonthlyPOTrendWidget.prototype.widgetFirevalueChanged = function (value) {
        if (this.listener) {
            this.listener.widgetFirevalueChanged(value);
        }
    };

    VAS.VAS_208_MonthlyPOTrendWidget.prototype.addChangeListener = function (listener) {
        this.listener = listener;
    };

    VAS.VAS_208_MonthlyPOTrendWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_208_MonthlyPOTrendWidget.prototype.widgetSizeChange = function (height, width) { };

    VAS.VAS_208_MonthlyPOTrendWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_208_MonthlyPOTrendWidget.prototype.dispose = function () {
