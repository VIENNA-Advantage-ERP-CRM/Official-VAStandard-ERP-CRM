 ...
 *
 * Backend:
 * - VAS_ProductSearchWidget/SearchProducts
 * - VAS_ProductSearchWidget/GetProductDetail
 *
...
; (function (VAS, $) {
    ...
    VAS.VAS_ProductSearchWidget = function () {
        ...
        function searchProducts(searchText) {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_ProductSearchWidget/SearchProducts',
                type: 'GET',
                dataType: 'json',
                data: {
                    q: searchText,
        ...
        function loadProductDetail(productId, productName, productCode) {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_ProductSearchWidget/GetProductDetail',
                type: 'GET',
                dataType: 'json',
                data: {
    ...
    VAS.VAS_ProductSearchWidget.prototype.widgetFirevalueChanged = function (value) {
        if (this.listener) { this.listener.widgetFirevalueChanged(value); }
    };

    VAS.VAS_ProductSearchWidget.prototype.addChangeListener = function (listener) {
        this.listener = listener;
    };

    VAS.VAS_ProductSearchWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_ProductSearchWidget.prototype.widgetSizeChange = function () { };

    VAS.VAS_ProductSearchWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_ProductSearchWidget.prototype.dispose = function () {
