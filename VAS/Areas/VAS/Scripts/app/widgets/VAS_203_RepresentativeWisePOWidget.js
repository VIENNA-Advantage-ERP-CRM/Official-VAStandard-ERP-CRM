/**
 * VAS_203_RepresentativeWisePOWidget
...
; (function (VAS, $) {
    ...
    VAS.VAS_203_RepresentativeWisePOWidget = function () {
        ...
        function loadRepresentativeWisePO() {
            ...
            var url = VIS.Application.contextUrl + 'VAS_203_RepresentativeWisePOWidget/GetRepresentativeWisePO';
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function loadRepresentativePurchaseOrders(repId, repName, $host) {
            ...
            var url = VIS.Application.contextUrl + 'VAS_203_RepresentativeWisePOWidget/GetRepresentativePurchaseOrders';
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function openPurchaseOrderLinesModal(orderId) {
            var url = VIS.Application.contextUrl + 'VAS_203_RepresentativeWisePOWidget/GetPurchaseOrderLines';
            $.ajax({
                url: url,
                type: 'GET',
    ...
    VAS.VAS_203_RepresentativeWisePOWidget.prototype.widgetFirevalueChanged = function (value) {
        if (this.listener) {
            this.listener.widgetFirevalueChanged(value);
        }
    };

    VAS.VAS_203_RepresentativeWisePOWidget.prototype.addChangeListener = function (listener) {
        this.listener = listener;
    };

    VAS.VAS_203_RepresentativeWisePOWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_203_RepresentativeWisePOWidget.prototype.widgetSizeChange = function (height, width) { };

    VAS.VAS_203_RepresentativeWisePOWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_203_RepresentativeWisePOWidget.prototype.dispose = function () {
