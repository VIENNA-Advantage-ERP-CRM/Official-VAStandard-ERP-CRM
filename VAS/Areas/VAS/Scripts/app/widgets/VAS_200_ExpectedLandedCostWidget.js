/**
 * VAS_200_ExpectedLandedCostWidget
...
; (function (VAS, $) {
    ...
    VAS.VAS_200_ExpectedLandedCostWidget = function () {
        ...
        function loadData() {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_200_ExpectedLandedCostWidget/GetExpectedLandedCost',
                type: 'GET',
    ...
    VAS.VAS_200_ExpectedLandedCostWidget.prototype.widgetFirevalueChanged = function (value) {
        if (this.listener) { this.listener.widgetFirevalueChanged(value); }
    };

    VAS.VAS_200_ExpectedLandedCostWidget.prototype.addChangeListener = function (listener) {
        this.listener = listener;
    };

    VAS.VAS_200_ExpectedLandedCostWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_200_ExpectedLandedCostWidget.prototype.widgetSizeChange = function (height, width) { };

    VAS.VAS_200_ExpectedLandedCostWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_200_ExpectedLandedCostWidget.prototype.dispose = function () {
