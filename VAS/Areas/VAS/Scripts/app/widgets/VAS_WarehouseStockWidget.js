...
; (function (VAS, $) {
    ...
    VAS.VAS_WarehouseStockWidget = function () {
        ...
        function loadData() {
            $.ajax({
                url: VIS.Application.contextUrl + 'VAS_WarehouseStockWidget/GetWarehouses',
                type: 'GET',
                cache: false,
                success: function (response) {
                    ...
                    $.ajax({
                        url: VIS.Application.contextUrl + 'VAS_WarehouseStockWidget/GetStockRows',
                        type: 'GET',
                        cache: false,
    ...
    VAS.VAS_WarehouseStockWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_WarehouseStockWidget.prototype.widgetSizeChange = function () {
        this.widgetSizeChange();
    };

    VAS.VAS_WarehouseStockWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_WarehouseStockWidget.prototype.dispose = function () {
