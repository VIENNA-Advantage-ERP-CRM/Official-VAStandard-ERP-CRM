...
; (function (VAS, $) {
    ...
    VAS.VAS_197_Top10VendorsWidget = function () {
        ...
        function loadTopVendors() {
            ...
            var url = VIS.Application.contextUrl + 'VAS_197_Top10VendorsWidget/GetTopVendors';
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function loadVendorPurchaseOrders(vendorId, vendorName, $container) {
            ...
            var url = VIS.Application.contextUrl + 'VAS_197_Top10VendorsWidget/GetVendorPurchaseOrders';
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function openPurchaseOrderLinesModal(orderId) {
            var url = VIS.Application.contextUrl + 'VAS_197_Top10VendorsWidget/GetPurchaseOrderLines';
            $.ajax({
                url: url,
                type: 'GET',
    ...
    VAS.VAS_197_Top10VendorsWidget.prototype.widgetFirevalueChanged = function (value) {
        if (this.listener) {
            this.listener.widgetFirevalueChanged(value);
        }
    };

    VAS.VAS_197_Top10VendorsWidget.prototype.addChangeListener = function (listener) {
        this.listener = listener;
    };

    VAS.VAS_197_Top10VendorsWidget.prototype.init = function (windowNo, frame) {
        this.frame = frame;
    ...
    VAS.VAS_197_Top10VendorsWidget.prototype.widgetSizeChange = function (height, width) { };

    VAS.VAS_197_Top10VendorsWidget.prototype.refreshWidget = function () {
        this.refreshWidget();
    };

    VAS.VAS_197_Top10VendorsWidget.prototype.dispose = function () {
