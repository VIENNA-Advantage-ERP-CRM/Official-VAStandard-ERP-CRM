...
; (function (VAS, $) {
    ...
    VAS.VAS_167_PurchaseOrderLandedCost = function () {
        ...
        function renderHeaderCard() {
            ...
            // Blanket purchase order this one was released against
            // (C_Order.C_Order_Blanket). Both sides live in C_Order like the
            // sales order above, but this one is a PURCHASE transaction — it
            // carries no IsSOTrx flag, so it takes the plain mapping and opens
            // the Blanket Purchase Order window.
            if (data.BlanketOrderId > 0) {
                $right.append(headerField(getMsg("VAS_167_BlanketOrder"),
