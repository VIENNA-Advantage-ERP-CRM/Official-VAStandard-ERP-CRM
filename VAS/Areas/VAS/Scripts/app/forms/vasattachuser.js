                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result != null && result.length > 0) {
                            ...
                            for (var i = 0; i < result.length; i++) {                             
                                var line = {};
                                line['recid'] = result[i].recid;
                                line['Image'] = result[i].ImageUrl;
                                line['Name'] = result[i].Name;
                                line['Email'] = result[i].Email;
                                line['Mobile'] = result[i].Mobile;
                                line['SuperVisor'] = result[i].SupervisorName;
                                line['User_ID'] = result[i].UserID;
                                data.push(line);
                            }
                        }
                        dynInit(data);
