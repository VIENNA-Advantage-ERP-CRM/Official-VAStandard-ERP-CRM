...
; (function (VIS, $) {
    function VAS_TimeSheetInvoice() {
        ...
        var GetColumnID = function (ColumnName) {
            var Column_ID = VIS.dataContext.getJSONData(VIS.Application.contextUrl + "VAS_TimeSheetInvoice/GetColumnID", { "ColumnName": ColumnName }, null);
            return Column_ID;
        }
        ...
        function executeQuery() {
            ...
            $.ajax({
                url: VIS.Application.contextUrl + "VAS_TimeSheetInvoice/LoadGridData",
                type: 'POST',
                //async: false,
                data: {
        ...
        function GenerateInvoice(gridDataArray) {
            var AD_Cleint_ID = VIS.Env.getCtx().getAD_Client_ID();
            $.ajax({
                url: VIS.Application.contextUrl + "VAS_TimeSheetInvoice/GenerateInvoice",
                type: 'POST',
                //async: false,
                data: {
        ...
        this.Initialize = function () {
            ...
            if (btnFilter != null) {
                btnFilter.on("click", function () {
                    ...
                    $opnFilter.append($TimeAndExpenseDiv).append($TaskDiv).append($ProjectDiv).append($RequestDiv);
