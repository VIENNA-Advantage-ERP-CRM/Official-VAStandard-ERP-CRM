    ...
    VAS.VAS_OpenQuotationWidget = function () {
        ...
        this.initalize = function () {
            ...
            const orderContainer =
                ...
                '        <div>' + VIS.Msg.getMsg("VAS_OpenQuotation") + '</div>' +
                ' <span id="VAS_DeliveryCount_' + widgetID + '">0</span>'+
                '    </div>' +
                //'    <div class="VAS-delivery-count">' +
                //'        <div class="VAS-count-lbl">' + VIS.Msg.getMsg("VAS_Quotation") + ' <span id="VAS_DeliveryCount_' + widgetID + '">0</span></div>' +
                //'    </div>' +
        ...
        this.intialLoad = function (pageNo) {
            ...
            $.ajax({
                ...
                data: { pageNo: pageNo, pageSize: pageSize, Type: "OQ" },
                dataType: 'json',
        ...
        function displayOrderDetails(docNo, customerName, orderid) {
            ...
            var productContainer =
                ...
                '            ' + VIS.Msg.getMsg("VAS_BackToQuotations") +
                '        </h6>' +
                '<span id="VAS_GenerateOrder_' + widgetID + '" class="VAS-generate-delivery-btn" data-orderid="' + orderid + '" title="' + VIS.Msg.getMsg("VAS_GenerateOrder") + '">' +
