    ...
    public class InventoryCountUpdate : ProcessEngine.SvrProcess
    {
        ...
        protected override String DoIt()
        {
            ...
            if (_AdjustinventoryCount)
            {
                ...
                " AND t.MovementType NOT IN ('VI', 'IR') AND t.AD_Client_ID = " + inventory.GetAD_Client_ID() + @") mt ON m.M_Product_ID = mt.M_Product_ID 
                AND nvl(m.M_AttributeSetInstance_ID, 0) = nvl(mt.M_AttributeSetInstance_ID, 0) 
