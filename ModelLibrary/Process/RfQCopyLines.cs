        ...
        protected override String DoIt()
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                for (int j = 0; j < qtys.Length; j++)
                {
                    ...
                    newQty.SetBenchmarkPrice(qtys[j].GetBenchmarkPrice()); //VAI050--Set BenchmarkPrice
                    newQty.Set_Value("LineNetAmt", qtys[j].GetQty() * qtys[j].GetBenchmarkPrice()); //VAI050-Set LineAmount
