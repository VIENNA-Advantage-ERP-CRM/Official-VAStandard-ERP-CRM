        ...
        public bool ReActivateIt()
        {
            ...
            if (Env.IsModuleInstalled("VA097_"))
            {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    var SelectedValues = selectedTable.AsEnumerable().Select(s => s.Field<string>("DocumentNo")).ToArray();
                    string TenderID = string.Join(",", SelectedValues);
                    ...
                    {
                        _processMsg = Msg.GetMsg(GetCtx(), "VA097_Reactivate" + " = "+ TenderID);
                        return false;
                    }
