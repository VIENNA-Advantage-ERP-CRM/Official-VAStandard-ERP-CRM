...
INNER JOIN C_Order o ON (o.C_Order_ID=ol.C_Order_ID)
    ...
    WHERE IsActive='Y' AND Ref_C_Order_ID=" + Util.GetValueOfInt(Get_Value("Ref_C_Order_ID")), null, Get_Trx()));
        ...
        {
            int ad_window_id = Util.GetValueOfInt(DB.ExecuteScalar("SELECT AD_Window_ID FROM AD_Window WHERE IsActive = 'Y' AND Name = 'VAS_PurchaseOrder' OR Export_ID = 'VIS_181' ORDER BY AD_Window_ID DESC ")); // Purchase Order
